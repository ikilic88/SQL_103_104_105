...
Chıld tabloda on delete cascade komutu yazılmazsa 

1- Chıld tablo silinmeden oarent tablo silinmeye calısıldıgında pgadmın error veriri-
yani Chıld tablo silinmeden parent tablo silinemez

2- Child tablodaki veri slinmeden Parent tablodaki veri silinmeye calısıldıgında Pgadmin
error verir
yani Child tablodaki veri silinmeden Parent tablodaki veri silinemez

3-Child tabloda on delete cascade komutu yazılırsa

1-)  Child tanlo silinmeden Parent tablo silinebilir.
PgAdmin error vermez

2-) Child tablodaki verş silinmeden Parent tablodaki veri silinmeye calısıldığında 
PgAdmin error vermez Parebt tablodaki veriyi siler.
fakat bu durumda Child tablodaki verşde silinir
*/
